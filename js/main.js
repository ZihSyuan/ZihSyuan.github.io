;(function () {
	...
	var windowScroll = function() {
		...
		console.log($('div[data-section="home"]').is(':visible'));
		if (!$('div[data-section="home"]').is(':visible')) {
			console.log($('div[data-section="home"]').is(':visible'));
		...
		$(window).scroll(function(event){
			...
			if ($(this).scrollTop() > 0) {
				...
				else header.removeClass("navbar-fixed-top qbootstrap-animated slideInDown");
			}
		});
	};
